...
def test_reference_order_and_internship_group_survive_all_formats(tmp_path):
    profile = {
        "meta": {"name": "测试候选人", "language": "zh", "market": "cn",
                 "section_order": ["education", "experience", "internships", "projects", "skills"],
                 "headings": {"education": "教育背景", "experience": "工作经历", "internships": "实习经历", "projects": "个人项目与影响力", "skills": "技能"}},
    ...
    assert headings == ["教育背景", "工作经历", "实习经历", "个人项目与影响力", "技能"]
    ...
    assert md.index("## 教育背景") < md.index("## 工作经历") < md.index("## 实习经历") < md.index("## 个人项目与影响力") < md.index("## 技能")
