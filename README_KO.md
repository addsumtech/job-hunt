...
| **apply · 이력서 작성과 지원 준비** | 지원할 직무를 정하고 맞춤 서류가 필요할 때 | 맞춤 이력서, 선택적 지원 동기서, 검토 기록, 면접 준비 자료 |
...
## 중국어·영어 이력서 작성과 지원 준비

기존 이력서를 다듬거나 학력·경력·프로젝트 경험을 제공해 초안부터 만들 수 있습니다. 이후 목표 직무에 맞춰 내용을 조정합니다. 중국어, 영어 등 지원 언어로 편집 가능한 Word 파일과 조판된 PDF를 제공합니다.

완성된 구직 보고서는 최종 목록에 남긴 모든 공고의 상세 내용을 하나씩 확인합니다. 읽을 수 없는 공고는 이유와 미확인 상태를 표시합니다. 목록 요약은 초기 선별에 사용할 수 있지만, 목표 개수를 채웠다는 이유만으로 조사를 완료하지 않습니다. 초기 목록을 먼저 받고 싶다면 명시적으로 요청할 수 있습니다.
...
2026년 9월 11일 실제 공고 조사 결과를 익명화하고 영어로 옮긴 발췌본입니다. 우선순위, 관련 경험, 부족한 근거와 준비 사항을 보여 줍니다. 요약만 확인한 후보가 포함된 당시 예시를 보존한 것이며, 현재 완성본 전달 과정은 공고별 상세 확인을 요구합니다. 가상 이력서의 경험을 보고서 판단에 사용하지 않았습니다. 이미지를 클릭하면 원본 크기로 볼 수 있습니다.
