...
**Las reglas del mercado y el idioma de salida se tratan por separado.** El generador de CV incluye títulos de sección y etiquetas de datos personales en inglés, neerlandés, alemán, francés, español, italiano, chino, japonés y coreano. Algunos textos obligatorios y fichas de recuento de `discover` y `assess` solo admiten inglés y chino actualmente. Los informes íntegramente en japonés, coreano o español pueden fallar la validación y necesitar estructura en inglés o chino. Los cinco idiomas del README no implican una localización completa de todos los flujos; los PDF también necesitan fuentes adecuadas para el idioma de salida.
