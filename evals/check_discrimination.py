...
# Importable as `from evals import check_discrimination` (repo root on sys.path) AND runnable as
# `python3 evals/check_discrimination.py`, where sys.path[0] is evals/ and the package would
