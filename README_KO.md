...
기업이나 업계를 조사할 때는 공식 사이트, 뉴스, GitHub, 공개 토론 등의 [추가 정보원](references/supplementary-sources.md)도 활용할 수 있습니다. 샤오홍슈·더우인의 로그인 상태를 사용하는 검색은 해당 상담에서 사용자의 허가를 받은 뒤 진행합니다.
